    ...
    headPhotoClick:function(){
        ...
        if(m_global.isLogin==true){
            ...
            layui.use('layer', function(){
                ...
                var login_form = '<form class="layui-form" action="">'+
                '<div class="layui-form-item">'+
                //'<lable class="layui-form-label">邮箱</lable>'+
                '<div class="layui-input-block" style="margin-left:30px;margin-right:30px;width=300px">'+
                ...
                '</div>'+
                '</div>'+
                '<a href="/novel/register" style="font-size:10px;text-align:right;width:140px;display:inline-block;margin-right:10px;margin-left:30px">注册</a>'+
                '<em>|</em>'+
                '<a href="/novel/passwordChange" style="font-size:10px;text-align:left;width:140px;display:inline-block;margin-left:10px">忘记密码</a>'+
                '</form>'
                layer.open({
                    title:['登录',]
                    ,content:login_form
                    ...
                    ,yes:function(index,layero){
                        $.ajax({
                            ...
                            type:'POST',
                            datatType:'json',
                            data:{'Email':$("[name='Email']").val(),'password':$("[name='password']").val(),'csrfmiddlewaretoken':$.cookie("csrftoken")},
                    ...
                    ,success:function(){
                    $('.layui-layer-content').css('height','140px');
                    },
                });
            });
        }
